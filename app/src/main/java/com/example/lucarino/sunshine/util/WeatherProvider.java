...
import com.example.lucarino.sunshine.data.WeatherDbHelper;
...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        if(null == selection) selection = "1"; // this deletes all the rows from the table.

        switch (match) {
            case WEATHER: {
                deletedEntries = writableDatabase.delete(WeatherContract.WeatherEntry.TABLE_NAME, selection, selectionArgs);
                break;
            }
            case LOCATION: {
                deletedEntries = writableDatabase.delete(WeatherContract.LocationEntry.TABLE_NAME, selection, selectionArgs);
                break;
            } default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
