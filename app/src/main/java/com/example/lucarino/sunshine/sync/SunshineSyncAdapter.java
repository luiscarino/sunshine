package com.example.lucarino.sunshine.sync;
...
import com.example.lucarino.sunshine.MainActivity;
import com.example.lucarino.sunshine.R;
import com.example.lucarino.sunshine.Utility;
...
// 60 seconds (1 minute)  180 = 3 hours
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            final String API_ID = "b845a653c9538f57eaafe0cce483771b";
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, API_ID)
                    .build();
            ...
            Log.d(LOG_TAG, "onHandleIntent - Response : " + forecastJsonStr);
    ...
    private void createNotification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getContext())
                ...
                .setContentText("Weather updates ready for you");

        // create an explicit intent for the main activity.
        Intent resultIntent = new Intent(getContext(), MainActivity.class);

        // create an artificial back stack for the started activity.
        ...
        // adds the intent to that starts the activity to the top of the stack
